// Combines two images into an Anaglyph Yellow/Blue grayscale image
...
float4 YellowBlueGray(float2 Tex : TEXCOORD0) : COLOR
{
...
technique ViewShader
{
    ...
    {
		VertexShader = null;
        PixelShader  = compile ps_2_0 YellowBlueGray();
    }
}
