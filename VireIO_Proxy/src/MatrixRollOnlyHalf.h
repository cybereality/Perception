...
File <MatrixRollOnlyHalf.h> and
Class <MatrixRollOnlyHalf> :
...
#ifndef MATRIXROLLONLYHALF_H_INCLUDED
#define MATRIXROLLONLYHALF_H_INCLUDED
/**
...
public:
	...
	*/
	MatrixRollOnlyHalf(UINT modID, std::shared_ptr<ViewAdjustment> adjustmentMatrices, bool transpose) 
	...
	***/
	...
	{
		// in * rollMatrix
		outLeft = in * m_spAdjustmentMatrices->ProjectionInverse() * m_spAdjustmentMatrices->RollMatrixHalf() * m_spAdjustmentMatrices->Projection();
		outright = in * m_spAdjustmentMatrices->ProjectionInverse() * m_spAdjustmentMatrices->RollMatrixHalf() * m_spAdjustmentMatrices->Projection();
	}
};
#endif