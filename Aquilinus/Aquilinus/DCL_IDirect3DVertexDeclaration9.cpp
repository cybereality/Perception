...
#define AQU_IDIRECT3DVERTEXDECLARATION9_SET_DATA______(a,b,c) m_pcTransferSite->m_ppNOD_IDirect3DVertexDeclaration9[a]->m_paCommandersTemporary[b]->m_pOutput = (void*)&c;
