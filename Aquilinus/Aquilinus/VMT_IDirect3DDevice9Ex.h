...
********************************************************************/
#ifndef VMT_IDIRECT3DDEVICE9EX_ENUM
#define VMT_IDIRECT3DDEVICE9EX_ENUM

#include "VMT_IDirect3DDevice9.h"

namespace VMT_IDIRECT3DDEVICE9EX
{

	/**
	* Virtual Methods Table for IDirect3DDevice9Ex.
	***/
	enum VMT_IDirect3DDevice9Ex
	{
		/*** IDirect3DDevice9Ex methods ***/
		SetConvolutionMonoKernel      = 129,
		ComposeRects                  = 130,
		PresentEx                     = 131,
		GetGPUThreadPriority          = 132,
		SetGPUThreadPriority          = 133,
		WaitForVBlank                 = 134,
		CheckResourceResidency        = 135,
		SetMaximumFrameLatency        = 136,
		GetMaximumFrameLatency        = 137,
		CheckDeviceState              = 138,
		CreateRenderTargetEx          = 139,
		CreateOffscreenPlainSurfaceEx = 140,
		CreateDepthStencilSurfaceEx   = 141,
		ResetEx                       = 142,
		GetDisplayModeEx              = 143,
