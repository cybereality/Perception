...
********************************************************************/
#ifndef DCL_IDIRECT3DQUERY9_CLASS
#define DCL_IDIRECT3DQUERY9_CLASS
...
/**
* IDirect3DQuery9 detour class.
***/
class DCL_IDirect3DQuery9
{
public:
	DCL_IDirect3DQuery9(AQU_TransferSite* pcTransferSite);
	~DCL_IDirect3DQuery9();

	/*** IUnknown methods ***/
	HRESULT WINAPI QueryInterface              (IDirect3DQuery9* pcThis, REFIID riid, void** ppvObj);
	ULONG   WINAPI AddRef                      (IDirect3DQuery9* pcThis);
	ULONG   WINAPI Release                     (IDirect3DQuery9* pcThis);
	...
	/*** DCL_IDirect3DQuery9 public methods ***/
	HRESULT        SetSuperFunctionPointer     (VMT_IUNKNOWN::VMT_IUnknown eFunc, UINT_PTR dwFunc);
	HRESULT        SetSuperFunctionPointer     (VMT_IDIRECT3DQUERY9::VMT_IDirect3DQuery9 eFunc, UINT_PTR dwFunc);
