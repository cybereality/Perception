...
#define AQUILINUS_RTE_DRAWING_API AQU_DrawingAPIs::API_OpenGL
//#define AQUILINUS_RTE_DRAWING_API AQU_DrawingAPIs::API_DirectDraw

/*** Aquilinus Runtime Environment public methods ***/
