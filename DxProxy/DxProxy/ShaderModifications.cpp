...
ShaderModifications::ShaderModifications() :
...
std::vector<StereoShaderConstant<float>> ShaderModifications::GetModifiedConstantsF(IDirect3DVertexShader9* pActualVertexShader)
{
