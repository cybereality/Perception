...
***/
StereoBackBuffer::StereoBackBuffer(UINT Width, UINT Height, D3DFORMAT Format, IDirect3DSurface9* pActualSurfaceLeft, IDirect3DSurface9* pActualSurfaceRight, BaseDirect3DDevice9* pOwningDevice, HANDLE SharedHandleLeft, HANDLE SharedHandleRight) :
	D3D9ProxySurface(Width, Height, Format, pActualSurfaceLeft, pActualSurfaceRight, pOwningDevice, NULL, SharedHandleLeft, SharedHandleRight)
{
}
