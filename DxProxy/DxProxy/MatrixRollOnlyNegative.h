...
public:
	...
	*/
	MatrixRollOnlyNegative(UINT modID, std::shared_ptr<ViewAdjustment> adjustmentMatrices, bool transpose) 
	...
	***/
	...
	{
		// in * rollMatrix
		outLeft = in * m_spAdjustmentMatrices->ProjectionInverse() * m_spAdjustmentMatrices->RollMatrixNegative() * m_spAdjustmentMatrices->Projection();
		outright = in * m_spAdjustmentMatrices->ProjectionInverse() * m_spAdjustmentMatrices->RollMatrixNegative() * m_spAdjustmentMatrices->Projection();
	};
};
#endif