...
File <MatrixRollNegativeConvergence.h> :
...
#ifndef MATRIXROLLNEGATIVECONVERGENCE_H_INCLUDED
#define MATRIXROLLNEGATIVECONVERGENCE_H_INCLUDED
/**
* @file MatrixRollNegativeConvergence.h
...
* For shadow fixes.
*/
class MatrixRollNegativeConvergence : public ShaderMatrixModification
{
public:
	/**
	...
	*/
	MatrixRollNegativeConvergence(UINT modID, std::shared_ptr<ViewAdjustment> adjustmentMatrices, bool transpose)
	...
	***/
	...
	{
		// in * rollMatrix
		outLeft = in * m_spAdjustmentMatrices->RollMatrixNegative() * m_spAdjustmentMatrices->ConvergenceOffsetLeft();
		outright = in * m_spAdjustmentMatrices->RollMatrixNegative() * m_spAdjustmentMatrices->ConvergenceOffsetRight();
	};
};
#endif