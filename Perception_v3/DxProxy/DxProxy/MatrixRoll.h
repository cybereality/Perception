...
#ifndef MATRIXROLL_H_INCLUDED
#define MATRIXROLL_H_INCLUDED
/**
* @file MatrixRoll.h
...
* For shadow fixes.
*/
class MatrixRoll : public ShaderMatrixModification
{
public:
	/**
	...
	*/
	MatrixRoll(UINT modID, std::shared_ptr<ViewAdjustment> adjustmentMatrices, bool transpose)
	...
	***/
	...
	{
		// in * rollMatrix
		outLeft = in * m_spAdjustmentMatrices->RollMatrix();
		outright = in * m_spAdjustmentMatrices->RollMatrix();
	};
};
#endif