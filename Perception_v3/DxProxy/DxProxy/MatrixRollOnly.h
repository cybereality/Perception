...
public:
	...
	*/
	MatrixRollOnly(UINT modID, std::shared_ptr<ViewAdjustment> adjustmentMatrices, bool transpose) 
	...
	***/
	...
	{
		// in * rollMatrix
		outLeft = in * m_spAdjustmentMatrices->ProjectionInverse() * m_spAdjustmentMatrices->RollMatrix() * m_spAdjustmentMatrices->Projection();
		outright = in * m_spAdjustmentMatrices->ProjectionInverse() * m_spAdjustmentMatrices->RollMatrix() * m_spAdjustmentMatrices->Projection();
	};
};
#endif